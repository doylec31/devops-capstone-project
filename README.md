...
![Build Status](https://github.com/doylec31/devops-capstone-project/actions/workflows/ci-build.yaml/badge.svg)
...
These labss are designed to be executed in the IBM Developer Skills Network Cloud IDE with OpenShift. Please use the links provided in the Coursera Capstone project to access the lab environment.
